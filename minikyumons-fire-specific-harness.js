...
click("green-button"); assertTrue(elements["egg-modal"].style.display === "block", "START abre os tres ovos"); click("dpad-right"); click("dpad-right"); assertTrue(elements["egg-fire"].className.indexOf("selected") >= 0, "D-pad navega para ovo Fogo"); click("green-button"); assertTrue(elements["hatch-yard-egg"].style.display === "block", "confirmar ovo inicia eclosao no quintal");
assertTrue(runUntil(function () { return state().started === true; }, 60), "eclosao termina e inicia o pet"); assertTrue(elements["hatch-yard-egg"].style.display === "none", "ovo some apos eclosao"); assertTrue(elements["pet-asset"].src.indexOf("fire_rebuild/idle-01.png") >= 0, "Fogo inicia com idle novo");
click("green-button"); assertTrue(elements["submenu-strip"].className.indexOf("menu-hidden") < 0, "Alimentar abre submenu"); click("dpad-left"); click("green-button"); assertTrue(state().hygiene > 68, "Agua melhora higiene"); assertTrue(elements["pet-asset"].src.indexOf("fire_rebuild/water-01.png") >= 0, "Fogo usa animação nova de beber água");
click("dpad-right"); click("green-button"); click("dpad-right"); click("dpad-right"); var beforeEnergy = state().energy; click("green-button"); assertTrue(state().energy < beforeEnergy, "treino reduz energia"); assertTrue(elements["pet-asset"].src.indexOf("fire_rebuild/attack-01.png") >= 0, "Fogo usa animação nova de ataque no treino");
...
click("dpad-right"); click("green-button"); click("green-button"); assertTrue(state().sleeping === true, "sono ativa animacao de dormir"); assertTrue(elements["pet-asset"].src.indexOf("fire_rebuild/sleep-zzz-01.png") >= 0, "Fogo usa animação nova de sono com Zzz");
