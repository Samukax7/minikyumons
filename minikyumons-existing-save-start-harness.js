...
var storage = { "minikyumons_save_v5_zero_rebuild": JSON.stringify({ version: 5, name: "Existing", species: "Água", started: true, level: 1, xp: 0, stage: "Bebê", expression: "neutral", sleeping: false, hunger: 80, energy: 80, happiness: 80, hygiene: 80, health: 100, bond: 0, care: 0, dirt: 0, poop: 0, memories: ["save existente"], personality: { carinhoso: 0, curioso: 0, brincalhao: 0 }, routine: { lastDay: "", streak: 0, lastAction: "" }, lastSeen: Date.now(), totalMinutes: 0 }) };
var windowShim = {
...
assertTrue(runUntil(function () { return elements["hatch-yard-egg"].style.display === "none"; }, 60), "eclosao termina e inicia o pet"); assertTrue(elements["hatch-yard-egg"].style.display === "none", "ovo some apos eclosao");
