...
click("green-button"); assertTrue(elements["egg-modal"].style.display === "block", "START abre os tres ovos"); assertTrue(elements["egg-water"].className.indexOf("selected") >= 0, "Água é o ovo inicial selecionado"); click("green-button"); assertTrue(elements["hatch-yard-egg"].style.display === "block", "confirmar ovo inicia eclosao no quintal");
assertTrue(runUntil(function () { return state().started === true; }, 60), "eclosao termina e inicia o pet"); assertTrue(elements["hatch-yard-egg"].style.display === "none", "ovo some apos eclosao"); assertTrue(elements["pet-asset"].src.indexOf("water_rebuild/idle-01.png") >= 0, "Água inicia com idle novo");
click("green-button"); assertTrue(elements["submenu-strip"].className.indexOf("menu-hidden") < 0, "Alimentar abre submenu"); click("dpad-left"); click("green-button"); assertTrue(state().hygiene > 68, "Agua melhora higiene"); assertTrue(elements["pet-asset"].src.indexOf("water_rebuild/water-01.png") >= 0, "Água usa a nova animação de beber");
...
click("dpad-right"); click("green-button"); assertTrue(state().happiness > 82, "carinho melhora humor"); assertTrue(elements["pet-asset"].src.indexOf("water_rebuild/head-turn-01.png") >= 0, "Água usa a nova animação de olhar no carinho");
